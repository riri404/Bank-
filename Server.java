...
public class Server extends Thread{
     ...
     */  
     public void initializeAccounts()
     {
        ...
        {
        	/** puts information from the account constructor into a sever array 
        	 */
            try                 
           {   account[i] = new Accounts(); // constructor of method of account
     ...
     {   int accIndex;             	/* Index position of account to update */
         ...
         { 
        	 ...
        	 while(objNetwork.getInBufferStatus().equals("empty") && !objNetwork.getClientConnectionStatus().equals("disconnected"))
        		 Thread.yield();     //Using a while loop
    ...
    {   Transactions trans = new Transactions();
    	...
    	serverStartTime = System.currentTimeMillis();// returns the time in milisec
